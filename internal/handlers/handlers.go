...
import (
	...
	"github.com/harishkrishnan24/bookings/internal/forms"
	...
	"github.com/harishkrishnan24/bookings/internal/repository"
	"github.com/harishkrishnan24/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	Dear %s: <br>
	A reservation has been made for %s from %s to %s`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))
